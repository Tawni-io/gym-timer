...
/**
 * Ensure I2C + AXP2602 probe. Idempotent; safe if touch_init already ran.
 * Returns true if PMIC present.
 */
bool board_power_init(void);

/** True if AXP2602 probed OK (board PMIC present). Cached after board_power_init. */
